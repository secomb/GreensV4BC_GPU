...
void input(void)
{
	...
	extern float fn,alphab,p50,cs,q0fac,totalq,errfac,lowflowcrit/*,pcr,m0,gf0,gf1*/;
	...
	////scale flows according to factor q0fac.  Modified 2012. Moved to greens November 2016
